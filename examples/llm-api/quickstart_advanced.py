...
example_prompts = [
    ...
    "The capital of France is something",
    "The future of AI is something",
    "The weather today is something",
    "Hello, my name is not something",
    "The capital of France is not something",
    "The future of AI is not something",
    "The weather today is not something",
    "Hello, my name is new",
    "The capital of France is new",
    "The future of AI is new",
    "The weather today is new",
    "Hello, my name is not new",
    "The capital of France is not new",
    "The future of AI is not new",
    "The weather today is not new",
    "Hello, my name is something new",
    "The capital of France is something new",
    "The future of AI is something new",
    "The weather today is something new",
    "Hello, my name is not something new",
    "The capital of France is not something new",
    "The future of AI is not something new",
    "The weather today is not something new",
    "Hello, my name is from",
    "The capital of France is from",
    "The future of AI is from",
    "The weather today is from",
    "Hello, my name is not from",
    "The capital of France is not from",
    "The future of AI is not from",
    "The weather today is not from",
    "Hello, my name is something from",
    "The capital of France is something from",
    "The future of AI is something from",
    "The weather today is something from",
    "Hello, my name is not something from",
    "The capital of France is not something from",
    "The future of AI is not something from",
    "Hello, my name is",
    "The capital of France is",
    "The future of AI is",
    "The weather today is",
    "Hello, my name is not",
    "The weather today is not something from",
    "Hello, my name is new from",
    "The capital of France is new from",
    "The future of AI is new from",
    "The weather today is new from",
    "Hello, my name is not new from",
    "The capital of France is not new from",
    "The future of AI is not new from",
    "The weather today is not new from",
    "Hello, my name is something new from",
    "The capital of France is something new from",
    "The future of AI is something new from",
    "The weather today is something new from",
    "Hello, my name is not something new from",
    "The capital of France is not something new from",
    "The future of AI is not something new from",
    "The weather today is not something new from",
]
...
def add_llm_args(parser):
    ...
    parser.add_argument('--enable_two_batch_overlap',
                        default=False,
                        action='store_true')
    parser.add_argument('--moe_load_balancer', type=str, default=None)
...
def setup_llm(args, **kwargs):
    ...
    llm = LLM(
        ...
        moe_config=MoeConfig(
            ...
            load_balancer=args.moe_load_balancer),
