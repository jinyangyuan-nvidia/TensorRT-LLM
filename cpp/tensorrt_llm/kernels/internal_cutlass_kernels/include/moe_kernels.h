...
private:
    static TmaWarpSpecializedGroupedGemmInput computeStridesTmaWarpSpecialized(int64_t const* expert_first_token_offset,
        ...
        WeightType const* weights, float const* fp8_dequant,
...
public:
    ...
    void init(CutlassMoeFCRunnerInterface& runner, GemmToProfile gemm_to_profile, nvinfer1::DataType dtype,
        ...
        bool min_latency_mode, bool use_fp4, bool use_fp8_block_scaling, MOEParallelismConfig parallelism_config)
    {
        mInterface = &runner;
        ...
        mL2CacheSize = common::getL2CacheSize();
